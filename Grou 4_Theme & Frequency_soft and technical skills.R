...
library(RWeka)
library(readxl)
import_data <- read_excel("C:\\Users\\Tai Nguyen\\Desktop\\Linh Python\\student_dataset.xlsx" ,  sheet = "Skills employer")

#Dataset column to read the text
text_data <- import_data$`What are the student's strengths?`
