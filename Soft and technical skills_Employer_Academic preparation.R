...
library(RWeka)
library(readxl)
import_data <- read_excel("Full_Co-op_dataset.xlsx" ,  sheet = "Skills employer")

#Dataset column to read the text
text_data <- import_data$`What changes, if any, would you suggest for the academic preparation of this student?`
